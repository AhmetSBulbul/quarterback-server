...
type RegionServiceClient interface {
	...
	GetRegionByDistrictId(ctx context.Context, in *commonpb.GetByIdRequest, opts ...grpc.CallOption) (*Region, error)
}
...
func (c *regionServiceClient) GetRegionByDistrictId(ctx context.Context, in *commonpb.GetByIdRequest, opts ...grpc.CallOption) (*Region, error) {
	out := new(Region)
	err := c.cc.Invoke(ctx, "/region.RegionService/GetRegionByDistrictId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegionServiceServer interface {
	...
	GetRegionByDistrictId(context.Context, *commonpb.GetByIdRequest) (*Region, error)
...
func (UnimplementedRegionServiceServer) GetRegionByDistrictId(context.Context, *commonpb.GetByIdRequest) (*Region, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRegionByDistrictId not implemented")
}
...
func _RegionService_GetRegionByDistrictId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(commonpb.GetByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegionServiceServer).GetRegionByDistrictId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/region.RegionService/GetRegionByDistrictId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegionServiceServer).GetRegionByDistrictId(ctx, req.(*commonpb.GetByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RegionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRegionByDistrictId",
			Handler:    _RegionService_GetRegionByDistrictId_Handler,
		},
	},
