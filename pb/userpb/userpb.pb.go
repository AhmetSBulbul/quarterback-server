...
var file_userpb_proto_rawDesc = []byte{
	...
	0x08, 0x01, 0x10, 0x02, 0x32, 0xe3, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x0a, 0x41,
...
var file_userpb_proto_depIdxs = []int32{
	...
	13, // 12: user.UserService.AddComment:input_type -> common.CommentRequest
	4,  // 13: user.UserService.GetMe:output_type -> user.UserResponse
	4,  // 14: user.UserService.GetUser:output_type -> user.UserResponse
	5,  // 15: user.UserService.SearchUsers:output_type -> user.UserListResponse
	4,  // 16: user.UserService.UpdateUser:output_type -> user.UserResponse
	4,  // 17: user.UserService.UploadAvatar:output_type -> user.UserResponse
	6,  // 18: user.UserService.ToggleFollow:output_type -> user.FollowResponse
	7,  // 19: user.UserService.ToggleBlock:output_type -> user.BlockResponse
	14, // 20: user.UserService.AddComment:output_type -> common.CommentResponse
