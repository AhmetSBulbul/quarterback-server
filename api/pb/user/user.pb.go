...
var file_user_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x9d, 0x02, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2a, 0x0a, 0x05, 0x47, 0x65, 0x74,
	0x4d, 0x65, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x1a, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x0a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x0c, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x0c, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x1a, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*common.Query)(nil),              // 5: common.Query
	...
	(*common.GetByIdRequest)(nil),     // 9: common.GetByIdRequest
	(*common.File)(nil),               // 10: common.File
}
var file_user_proto_depIdxs = []int32{
	5,  // 0: user.UserSearchRequest.query:type_name -> common.Query
	6,  // 1: user.UserSearchRequest.pagination:type_name -> common.PaginationRequest
	2,  // 2: user.UserResponse.user:type_name -> user.User
	2,  // 3: user.UserListResponse.user:type_name -> user.User
	7,  // 4: user.UserListResponse.pagination:type_name -> common.PaginationResponse
	8,  // 5: user.UserService.GetMe:input_type -> common.Empty
	9,  // 6: user.UserService.GetUser:input_type -> common.GetByIdRequest
	...
	10, // 9: user.UserService.UploadAvatar:input_type -> common.File
	3,  // 10: user.UserService.GetMe:output_type -> user.UserResponse
	3,  // 11: user.UserService.GetUser:output_type -> user.UserResponse
	4,  // 12: user.UserService.SearchUsers:output_type -> user.UserListResponse
	3,  // 13: user.UserService.UpdateUser:output_type -> user.UserResponse
	3,  // 14: user.UserService.UploadAvatar:output_type -> user.UserResponse
